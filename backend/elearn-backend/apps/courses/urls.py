...
urlpatterns = [
    ...
    path("batches/<int:pk>/students/bulk-update/", BatchStudentBulkUpdateView.as_view(), name="batch-student-bulk-update"),
    ...
    path("batches/<int:batch_id>/test-submissions/my-submissions/", MyTestSubmissionsListView.as_view(), name="my-test-submissions"),
